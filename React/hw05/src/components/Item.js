...
export const Item = ({listOfItems,markDone,deleteItem,editing,setEditing,editingItem,setEditingItem,cancel,save}) =>{
    return(
                    ...
                    <tr key={item.id}>
                        ...
                        <td>
                            ...
                            : <><td>{item.id}</td>
                                ...
                                <td><button onClick={()=>setEditing(item)}>Edit</button><button onClick={()=>{deleteItem(item.id)}}>Delete</button></td>
                            </>}
                        </tr>
                )
            })}
